...
abstract contract Tokenomics {
    ...
    string internal constant SYMBOL = "PPY";
    ...
    address internal charityAddress = 0xf57c4A1383446998630d6aa0d15ca74f88b035a5;
    address internal ventureCapitalAddress = 0x5AB0Fa648d0c96b1B8ec2759c0ae996963E945D5;
    ...
    /**
     * 0.1% will go into each of my kids wallets for when they grow up :)
     */
    address internal tip1 = 0x3277dFC7f136747B42eE01b97Af9C610Aa6631E1;
    address internal tip2 = 0xE71F74607ed7d3f070d94A6Ee820086472E84664;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 18, ventureCapitalAddress);

        // 0.1% as a tip to the devs kids
        _addFee(FeeType.ExternalToETH, 1, tip1);
        _addFee(FeeType.ExternalToETH, 1, tip2);
    }
